...
<div class="coursework-hero coursework-hero-metu">
  <p class="coursework-eyebrow">Middle East Technical University Northern Cyprus Campus</p>
  <h1>B.S. Computer Engineering coursework</h1>
  <p class="coursework-lead">The degree combined programming and computer-science foundations with software engineering, data systems, hardware, applied machine learning, and two stages of engineering design. The programme was taught in English.</p>
  <div class="coursework-facts">
    <div><strong>255.5</strong><span>degree ECTS</span></div>
    <div><strong>4 years</strong><span>full-time programme</span></div>
    <div><strong>English</strong><span>language of instruction</span></div>
  </div>
...
<div class="coursework-sources">
  ...
  <p>Course titles and credits are based on my completed degree record and diploma supplement. Topic summaries were cross-checked against the university's official curriculum and academic catalog.</p>
  <a href="https://www.ncc.metu.edu.tr/cng/curriculum" target="_blank" rel="noopener">Computer Engineering curriculum</a>
  <a href="https://catalog.metu.edu.tr/prog_courses.php?prog=355" target="_blank" rel="noopener">Department course catalog</a>
